...
# Put this file at deep_sort_pytorch/detector/YOLOv5/models/yolo.py
...
class Model(DetectionModel):
    """YOLOv5 model - updated to inherit from DetectionModel for compatibility"""
    pass


# For backwards compatibility - ensure DetectionModel is also available as Model
DetectionModel = DetectionModel  # This line ensures DetectionModel class is available for checkpoint loading
