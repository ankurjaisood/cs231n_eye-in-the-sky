# Forked from https://github.com/ultralytics/yolov5
# This file is used to train the YOLOv5 model on the cards dataset.
# To run, clone the YOLOv5 repo, place this file in the root directory, and run
